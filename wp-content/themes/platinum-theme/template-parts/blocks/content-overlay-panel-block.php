        ...
        <div class="content-overlay-panel__wrapper">
            <div class="content-overlay-panel__container">
                ...
                <div class="content-overlay-panel__text-wrapper">
                    <span data-aos="fade-right" data-aos-easing="ease-in" data-aos-delay="600" data-aos-duration="550" class="subtitle"><?php the_sub_field( 'subtitle' ); ?></span>
                    <h2 data-aos="fade-right" data-aos-easing="ease-in" data-aos-delay="800" data-aos-duration="550" class="content-overlay-panel__heading"><?php the_sub_field( 'heading' ); ?></h2>
                    <div data-aos="fade-right" data-aos-easing="ease-in" data-aos-delay="1000" data-aos-duration="550" class="content-overlay-panel__paragraph"><?php the_sub_field( 'paragraph' ); ?></div>
